...
declare const _default: React.ComponentClass<Pick<PropsType<OptionBaseType>, "placeholder" | "value" | "options" | "emptyText" | "disabled" | "onChange" | "renderOption" | "renderSelected"> & {
    theme?: {} | undefined;
}>;
