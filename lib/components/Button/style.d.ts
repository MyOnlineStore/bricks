...
declare const StyledAnchor: _S<_R.DetailedHTMLProps<_R.AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>, _T, _R.ClassAttributes<HTMLAnchorElement> & _R.AnchorHTMLAttributes<HTMLAnchorElement> & ButtonPropsType & _R.HTMLProps<HTMLElement>>;
