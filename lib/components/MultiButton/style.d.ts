...
declare const StyledMultiButton: _S<import("../Button").PropsType, _T, Pick<import("../Button").PropsType, "disabled" | "title" | "href" | "target" | "className" | "id" | "onClick" | "icon" | "iconAlign" | "variant" | "compact"> & {
    theme?: _T | undefined;
}>;
declare const StyledChevronButton: _S<import("../Button").PropsType, _T, Pick<import("../Button").PropsType, "disabled" | "title" | "href" | "target" | "className" | "id" | "onClick" | "icon" | "iconAlign" | "variant" | "compact"> & {
    theme?: _T | undefined;
}>;
