...
describe('Pagination', () => {
    ...
    it('should render a previous button when the active page is higher than 1', () => {
        const component = mountWithTheme(<Pagination total={12} current={3} LinkWrapper={LinkWrapper} />);
    ...
    it('should NOT render a previous button when the active page is the first', () => {
        const component = mountWithTheme(<Pagination total={12} current={1} LinkWrapper={LinkWrapper} />);
    ...
    it('should NOT render a next button when the active page is the last', () => {
        const component = mountWithTheme(<Pagination total={12} current={12} LinkWrapper={LinkWrapper} />);
