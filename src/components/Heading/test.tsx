...
describe('Heading', () => {
    ...
    it('should render a Heading component with light fontWeight', () => {
        const h1Light = mountWithTheme(<Heading hierarchy={1} light={true} />);
        const h2Light = mountWithTheme(<Heading hierarchy={2} light={true} />);
        const h3Light = mountWithTheme(<Heading hierarchy={3} light={true} />);
        const h4Light = mountWithTheme(<Heading hierarchy={4} light={true} />);
        const h5Light = mountWithTheme(<Heading hierarchy={5} light={true} />);
        const h6Light = mountWithTheme(<Heading hierarchy={6} light={true} />);
        const defaultLight = mountWithTheme(<Heading light={true} />);
