...
declare const StyledMultiButton: _S<import("../Button").PropsType, _T, Pick<import("../Button").PropsType, "title" | "className" | "id" | "color" | "action" | "disabled" | "href" | "target" | "icon" | "iconAlign" | "compact" | "variant" | "flat"> & {
    theme?: _T | undefined;
}>;
declare const StyledChevronButton: _S<import("../Button").PropsType, _T, Pick<import("../Button").PropsType, "title" | "className" | "id" | "color" | "action" | "disabled" | "href" | "target" | "icon" | "iconAlign" | "compact" | "variant" | "flat"> & {
    theme?: _T | undefined;
}>;
