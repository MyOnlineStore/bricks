...
declare const StyledMultiButton: _S<import("../Button").PropsType, _T, Pick<import("../Button").PropsType, "title" | "className" | "id" | "onClick" | "disabled" | "href" | "target" | "icon" | "compact" | "variant" | "iconAlign"> & {
    theme?: _T | undefined;
}>;
declare const StyledChevronButton: _S<import("../Button").PropsType, _T, Pick<import("../Button").PropsType, "title" | "className" | "id" | "onClick" | "disabled" | "href" | "target" | "icon" | "compact" | "variant" | "iconAlign"> & {
    theme?: _T | undefined;
}>;
