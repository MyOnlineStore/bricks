...
Within the back office of MyOnlineStore, we use two types of illustrations. One is defined as the "large icon" set, the other comes from undraw.co. When which style is used depends on its purpose.
