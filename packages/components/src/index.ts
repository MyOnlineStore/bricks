...
export { default as FileInput, FileInputInstanceType } from './components/FileInput';
...
export { default as colors } from './themes/MosTheme/colors';
...
export { default as PromotionBadge } from './components/PromotionBadge';
