...
const DemoContent = () => (
    <Text>
        ...
        dapibus ac facilisis in, egestas eget quam. Curabitur blandit tempus porttitor. Morbi leo risus, porta ac
...
const Demo: FC<PropsType> = () => {
    ...
    return (
        <Separated>
            ...
            />
            <Card label={<Text strong>Label</Text>} content={<DemoContent />} />
            <Card
                label={<Text strong>Label</Text>}
                description={
                    <>
...
storiesOf('Card', module).add('Default', () => <Demo />);
