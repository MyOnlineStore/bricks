...
const theme: ThemeType = {
    ...
    ImageRadio: {
        idle: {
            ...
            border: `none`,
            fill: colors.grey700,
            boxShadow: `0px 0px 0px 1px ${colors.grey400} inset`,
            focusBoxShadow: `0px 0px 0px 1px ${colors.grey400} inset, 0px 0px 0px 4px ${rgba(colors.grey200, 0.6)}`,
            checkmarkColor: colors.white,
        },
        idleDisabled: {
            backgroundColor: colors.grey100,
            fill: colors.grey300,
            border: `none`,
            boxShadow: `0px 0px 0px 1px ${colors.grey300} inset`,
        },
        active: {
            boxShadow: `0px 0px 0px 2px ${colors.green400} inset`,
            focusBoxShadow: `0px 0px 0px 2px ${colors.green400} inset, 0px 0px 0px 4px ${rgba(colors.green100, 0.875)}`,
        ...
        activeDisabled: {
            fill: colors.grey700,
            boxShadow: `0px 0px 0px 1px ${colors.green300} inset`,
            backgroundColor: colors.grey200,
        },
        error: {
            fill: colors.grey700,
            border: `none`,
            backgroundColor: rgba(colors.red100, 0.1),
            boxShadow: `0 0 0 2px ${colors.red300} inset`,
            focusBoxShadow: `0 0 0 2px ${colors.red300} inset, 0px 0px 0px 4px ${rgba(colors.red100, 0.875)}`,
        },
    },
    RadioButton: {
        idle: {
