import PopoverExamples from '../../containers/examples/overlays/PopoverExamples';
import TooltipExamples from '../../containers/examples/overlays/TooltipExamples';
import ModalWithIllustrationExamples from '../../containers/examples/overlays/ModalWithIllustrationExamples';
import DefaultModalExamples from '../../containers/examples/overlays/DefaultModalExamples';
...
### Takeaways
A high modal needs a vertical illustration to balance the design out. If you have a modal with little text, make sure you use a horizontal illustration to balance the modal out. 

<ModalWithIllustrationExamples />
