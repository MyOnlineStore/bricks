...
import IconButtonExamplesContainer from '../../containers/examples/IconButtonExamplesContainer';
import CtaButtonExamplesContainer from '../../containers/examples/CtaButtonExamplesContainer';
import ButtonGroupExamplesContainer from '../../containers/examples/ButtonGroupExamplesContainer';
...
#### Button with icon
The button with icon adds a regular sized icon (18x18px) 12px to the left of the button text. Based on this principle all other styles of the default button can be created.
